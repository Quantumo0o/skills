...
Trades Polymarket prediction markets on stock index milestones, major IPOs, earnings surprises, analyst upgrades, and company-specific financial events.
...
KEYWORDS = ['S&P 500', 'Dow Jones', 'Nasdaq', 'stock market', 'bull market', 'bear market', 'market crash', 'correction', 'IPO', 'earnings', 'revenue miss', 'beat', 'Berkshire', 'Warren Buffett', 'Apple earnings', 'Tesla earnings', 'Nvidia earnings', 'stock split', 'buyback', 'dividend', 'short squeeze', 'all-time high', 'market cap trillion', 'index rebalance']
...
def run(live: bool = False) -> None:
    ...
    print(f"[polymarket-equity-markets-trader] mode={mode} max_pos=${MAX_POSITION} min_vol=${MIN_VOLUME} max_spread={MAX_SPREAD:.0%} min_days={MIN_DAYS}")
...
if __name__ == "__main__":
    ap = argparse.ArgumentParser(description="Trades Polymarket prediction markets on stock index milestones, major IPOs, earnings surprises, analyst upgrades, and company-specific financial events.")
