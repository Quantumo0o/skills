...
description: >-
  ...
  Fengniao by Riskbird is a China company search and business registry skill for KYB, supplier verification, company due diligence, corporate risk screening, and counterparty risk.
...
4. 所有维度查询都使用 `entid`，不直接传企业名称或信用代码。
5. 如果是“做尽调”“查风险”这类多维度需求，只做一次主体解析，然后复用同一个 `entid` 查询多个维度。
