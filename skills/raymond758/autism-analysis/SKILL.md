...
description: "孤独症谱系障碍行为分析工具，针对儿童孤独症行为特征进行专项视频分析，识别核心症状特征，提供结构化分析报告和干预建议"
---
...
- 自动行为：
    ...
    2. **⚠️ 强制数据获取规则（次高优先级）**：如果用户触发任何历史报告查询关键词（如"查看所有孤独症报告"、"显示所有自闭症筛查报告"、"
       查看历史报告"等），**必须**：
...
- 表格输出示例：
  | 报告名称 | 分析类型 | 分析时间 | 点击查看 |
  |----------|----------|----------|----------|
  | 孤独症分析报告-20260312172200001 | 全面筛查 | 2026-03-12 17:22:00 | [🔗 查看报告](https://example.com/report?id=xxx) |
