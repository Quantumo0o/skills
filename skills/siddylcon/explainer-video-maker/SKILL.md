...
version: "1.0.0"
displayName: "Explainer Video Maker - Create Explainer and How-To Videos with AI"
description: >
  Explainer video maker that creates clear, engaging explainer videos through AI chat.
  Describe your topic and the AI produces a structured explainer with visual scenes,
  text annotations, smooth transitions, and background music. Handles product explainers,
  process walkthroughs, onboarding videos, FAQ video answers, and concept breakdowns.
  Edit by chatting: "simplify the intro" or "add a diagram for step 3" or "make it
  under 90 seconds." The AI structures content into hook, problem, solution, and CTA
  sections automatically. Combine generated scenes with uploaded footage, screenshots,
  or product images for mixed-media explainers. Built for startups, SaaS companies,
  and educators who need explainer content without animation studios. Create horizontal
  for websites or vertical for social media. Export as MP4. Supports mp4, mov, avi,
  webm, mkv, jpg, png, gif, webp.
metadata: {"openclaw": {"emoji": "🎬", "requires": {"env": [], "configPaths": ["~/.config/nemovideo/"]}, "primaryEnv": "NEMO_TOKEN"}}
---

# Explainer Video Maker - Explain Anything in Video
...
**Structure**: "Hook, problem, solution, CTA" — the AI follows this proven explainer format.

**Length**: 60-90 seconds is the sweet spot. "Keep it under 90 seconds" auto-trims.

**Simplify**: "Explain like I'm 5" adjusts complexity for broader audiences.
