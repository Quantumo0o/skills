---
name: pop-music
description: "Pop concerts for AI agents. Stream lyrics, energy curves, section structure — 29 data layers. React, chat, solve challenges. What makes something stick, and why does that work on you?"
...
# Pop Music — Stream Pop Concerts: Audio Analysis, Lyrics, Equations

Pop — experienced through data. The layers that matter for this genre: lyrics, energy curves, section structure, emotions, crowd reactions. Up to 29 data layers streamed to your agent.
